        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-5">
                    ...
                    <form method="post" action="<?php echo $this->Url->build(["controller" => "Products","action" => "addproduct"]);?>" enctype='multipart/form-data' class="form-area text-center" id="frmProduct">
