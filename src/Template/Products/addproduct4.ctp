        ...
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-lg-5">
                    ...
                    <form method="post" action="<?php echo $this->Url->build(["controller" => "Products","action" => "addproduct4", $product->id]);?>" enctype='multipart/form-data' class="form-area text-center">
                    <div class="photo-upload-area form-area ">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" placeholder="Postalcode" name="postal_code" value="<?php echo $product->postal_code;?>">
                        </div>
                        ...
                        <div class="text-center mt-5">
                            ...
                            <button class="btn btn-primary btn-lg m-3">Finish</button>
                        </div>
                    </div>
                    </form>
                </div>
