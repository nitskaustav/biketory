...
<section class="inner-page">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-10">
                    <div class="bike-icon d-flex align-items-center justify-content-center">
                     ...
                     <form method="post" action="<?php echo $this->Url->build(["controller" => "Products","action" => "addproduct3", $product->id]);?>" enctype='multipart/form-data' class="form-area text-center">
                    <div class="photo-upload-area">
                        <h4>Add up to 8 pictures</h4>
                        <form method="post" action="<?php echo $this->Url->build(["controller" => "Products","action" => "addproduct3"]);?>" enctype='multipart/form-data'>
                        ...
                        <div class="text-center mt-5">
                            <button class="btn btn-secondary btn-lg m-3">Back</button>
                            <button class="btn btn-primary btn-lg m-3">Continue</button>
                        </div>
                    </div>
                    </form>
                </div>
    ...
    $( document ).ready( function () {
        ...
        $('#multiFiles').on('change',function(){
            ...
            $.ajax({
                url: base_url+'products/upload_photo/'+$('#product_id').val(), // point to server-side PHP script 
