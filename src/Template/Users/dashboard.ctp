                ...
                <div class="right-side p-4">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="text-my-name">
                            ...
                            <p  class="mb-0 text-grey">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                        </div>
                    </div>
                    <div class="mt-4 my-account-add-list">
                        <h5 class="text-dark-grey font-weight-bold">My Currnet Ads</h5>
                        <div class="row">
...
<div id="myModal" class="modal fade srv-m" role="dialog">
  <div class="modal-dialog">
      ...
      <section>
        <div class="container" style="background-color: #fff; width: 685px;">
