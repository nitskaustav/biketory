                            ...
                            <div class="row">
                                ...
                                <div class="form-block">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-8">
                                            <?php echo $this->Form->input('first_name', array('class' => 'form-control', 'label' => false, 'required')); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-lg-4">Last Name</label>
                                        <div class="col-lg-8">
                                            <?php echo $this->Form->input('last_name', array('class' => 'form-control', 'label' => false, 'required')); ?>
                                        </div>
                                    </div>
