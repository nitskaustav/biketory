...
<section class="py-5">
        <div class="container">
            <h3 class="heading text-center">Clothing</h3>
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="mt-4">
                        <?php echo $this->Form->create($user,['controller'=>'gears','action'=>'editgear','class' => 'form-gear-area', 'id' => 'user-validate', 'enctype' => 'multipart/form-data']);?>
                        
                            <div class="row">
                                <div class="form-group col-lg-12">
                                    <label>Choose Clothing Category</label>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="product_name" value="<?php echo $return_data[1]; ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Brand</label>
                            ...
                            <p  class="text-center d-inline-block">
                                ...
                                <div class="form-group col-md-6">
                                    <label>Price</label>
                                    <input type="number" class="form-control" name="price" value="<?php echo $return_data[5]; ?>">
                                </div>
                                <div class="form-group col-md-6">
                                    <label>Item Location</label>
                                    <input type="text" class="form-control" name="item_location" value="<?php echo $return_data[6]; ?>">
                                </div>
                                <div class="form-group col-lg-12">
                    ...
                    //alert(response);return false;
                     ...
                     if(obj.Ack == 1){
                      ...
                      for(var i = 0; i < obj.data.length; i++){
                          file_path = '<?php echo $this->request->webroot; ?>product_img/'+obj.data[i].filename;
