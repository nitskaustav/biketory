<section class="py-5">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="mt-4">
                        <?php echo $this->Form->create('gearform',['controller'=>'gears','action'=>'addgear','class' => 'form-gear-area', 'id' => 'gearvalidate', 'enctype' => 'multipart/form-data']);?>
                            ...
                            <?php
                                foreach($colours as $colour_key){
                                    ...
                                    <p class="text-center d-inline-block">
                                        <input type="checkbox" id="<?php echo $colour_key->id; ?>" name="colour_id[]" value="<?php echo $colour_key->hexcode; ?>" />
